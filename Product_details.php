...
$row_prod = mysqli_fetch_assoc($query);
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <form method="POST">
                    ...
                    <hr>
                    <h4 class="selling-price">السعر :<span><?php echo $row_prod['price'] ?>د.ع</span></h4>
            ...
            <div class="col-lg-5">
                <form method="POST">
                    <div class="main-img">
                        <img src=" ./admin/img/<?php echo $row_prod['img'] ?>" alt="">
                    </div>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_cart'])) {
    ...
    if (isset($_SESSION['email'])) {
        ...
        $name_cart = $row_prod['product_name'];
        $img_cart = $row_prod['img'];
        $qty_cart = $_POST['qty'];
        $price_cart = $row_prod['price'];
...
?>
    ...
    <?php
        ...
        header("REFRESH:1;URL=product_details.php?id=$row_prod[p_id]");
    } else {
    ?>
        <script>
            $(function() {
