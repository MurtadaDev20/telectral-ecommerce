                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputText1" name="price_d" value="<?php echo $row['price_d'] ?>" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleInputText1" class="form-label">مقدار الخصم %</label>
                                        <input type="text" class="form-control" id="exampleInputText1" name="descount" value="<?php echo $row['descount'] ?>" required>
                                    </div>
    ...
    ?>
        ...
        ?>
            ...
            if ($size < 5000000) {
                ...
                $query = "UPDATE products_discount SET product_name = '$product_name', categories_name ='$cat_name'	 , qty ='$qty' , price='$price', price_d = '$price_d' , descount = '$descount' , description = '$desc' , img ='$img' WHERE p_id = '$id'";
